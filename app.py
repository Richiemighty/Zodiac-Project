...
def get_zodiac_sign(day, month):
    zodiac_signs = [
        ...
        ("Capricorn", (12, 22, 1, 19))  # Capricorn appears twice because of year transition
    ]
...
def index():
    if request.method == "POST":
        ...
        try:
            ...
            if zodiac_sign:
                info = zodiac_data[zodiac_sign]
                return render_template("result.html", age=age, gender=gender, sign=zodiac_sign, info=info)
            else:
                return "Error: Unable to determine zodiac sign."
